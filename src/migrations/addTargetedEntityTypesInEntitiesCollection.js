...
let professionalSubRolesInfo = {
	...
	'teacher-educator-SCERT': ['school'],
	'teacher-educator-DIET': ['school'],
	'teacher-educator-IASE': ['school'],
	'teacher-educator-univ-deptt': ['school'],
	'teacher-educator-TEI': ['school'],
	'teacher-educator-SIET': ['school'],
	'teacher-educator-CTE': ['school'],
	'teacher-educator-BASIC': ['school'],
	'block-resource-centre-coordinator-BRCC': ['block', 'cluster', 'school'],
	'cluster-resource-centre-oordinator-CRCC': ['cluster', 'school'],
	'state-coordinator': ['state', 'district', 'block', 'cluster', 'school'],
	'district-coordinator': ['district', 'block', 'cluster', 'school'],
	'assistant-district-coordinator': ['district', 'block', 'cluster', 'school'],
	coordinator: ['school'],
	'mentor-advisor': ['school'],
	'resource-person-state-district-block': ['state', 'district', 'block', 'cluster', 'school'],
	...
	'project-director-SPD': ['state', 'district', 'block', 'cluster', 'school'],
	'joint-director': ['school'],
	'assistant-state-project-director': ['state', 'district', 'block', 'cluster', 'school'],
	'additional-state-project-director': ['state', 'district', 'block', 'cluster', 'school'],
	'director-basic': ['school'],
	'head-autonomous-organization': ['school'],
	'director-SCERT': ['state', 'district', 'block', 'cluster', 'school'],
	'principal-DIET': ['school'],
	'collector-DM-DC': ['school'],
	'head-state-training-center': ['state', 'district', 'block', 'cluster', 'school'],
	'education-officer': ['school'],
	'chief-education-officer': ['state', 'district', 'block', 'cluster', 'school'],
	'district-education-officer-DEO': ['district', 'block', 'cluster', 'school'],
	'block-ducation-fficer-BEO': ['block', 'cluster', 'school'],
	...
	'director-state-education-board': ['state', 'district', 'block', 'cluster', 'school'],
}
